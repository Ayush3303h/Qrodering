              ...
              {cat.items.map((item) => {
                ...
                return (
                  <motion.article
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.12 }}
                    // Make layout responsive: stack on small screens, row on sm+
                    className="p-4 sm:p-5 flex flex-col sm:flex-row gap-4 items-start relative"
                  >
                    {/* Left: text */}
                    <div className="flex-1 min-w-0 pr-0 sm:pr-4">
                      ...
                      {/* price aligned under description */}
                      <div className="mt-4 text-indigo-600 font-semibold">₹{item.price}</div>
                    </div>
                    ...
                    <div className="w-full sm:w-32 flex-shrink-0 flex sm:flex-col items-start sm:items-end gap-2 sm:gap-0">
                      ...
                      {/* Add button: static on xs (below image), absolute positioning on sm+ to preserve original look */}
