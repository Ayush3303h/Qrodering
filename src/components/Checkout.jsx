...
//   return (
//     <div
//       className="max-w-xl mx-auto my-12 p-6 space-y-8 rounded-2xl shadow-2xl border border-[rgba(181,140,71,0.3)]"
//       style={{
//         backgroundColor: "#0b0605f0",
//       }}
//     >
//       {/* Back button */}
//       <button
//         onClick={() => navigate(-1)}
//         className="text-white hover:text-[#B58C47] font-medium mb-4 transition"
//       >
//         ← Back
//       </button>
...
//       {/* Header */}
//       <div className="text-center mb-6">
//         <h1 className="text-4xl font-bold text-white">Order Receipt</h1>

//         {/* Table box with gold border */}
//         <div className="inline-block mt-3 px-6 py-2 border border-[#B58C47] rounded-lg bg-transparent shadow-[0_0_10px_rgba(181,140,71,0.2)]">
//           <p className="text-white font-medium text-lg">
//             Table: {order.tableId || "N/A"}
//           </p>
//         </div>

//         <p className="text-[#B58C47] text-sm mt-2">
//           Order ID: {orderId}
//         </p>
//       </div>
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ delay: idx * 0.05 }}
//             className="flex items-center justify-between gap-4 p-3 border border-[#B58C47]/25 rounded-xl"
//           >
//             <img
//               src={item.imageURL || "/placeholder.jpg"}
//               alt={item.name}
...
//               <p className="text-white/80 text-sm">Qty: {item.quantity}</p>
//               {item.modifiers?.[0]?.option?.price && (
//                 <p className="text-[#B58C47] text-xs">
//                   Modifier: +₹{item.modifiers[0].option.price}
//                 </p>
//               )}
//             </div>
//             <span className="font-semibold text-[#B58C47]">
//               ₹{((item.price ?? 0) * item.quantity).toFixed(2)}
//             </span>
//           </motion.div>
//         ))}
...
//       {/* Totals */}
//       <div className="space-y-2 border border-[#B58C47]/25 rounded-xl p-4">
...
//           <span>₹{order.tax?.toFixed(2)}</span>
//         </div>
//         <div className="flex justify-between font-bold text-lg text-white border-t border-[#B58C47]/30 pt-2">
//           <span>Total</span>
//           <span>₹{order.total?.toFixed(2)}</span>
//         </div>
//       </div>
...
//           <svg className="w-full h-full transform -rotate-90">
//             <circle cx="96" cy="96" r="90" stroke="#3a2d1a" strokeWidth="12" fill="transparent" />
//             <circle
//               cx="96"
//               cy="96"
//               r="90"
...
//           </svg>
//           <div className="absolute inset-0 flex flex-col justify-center items-center">
//             <p className="text-lg text-white/80">⏱️ Remaining</p>
//             <p className="text-2xl font-bold text-[#B58C47]">
//               {formatTime(remaining)}
//             </p>
//           </div>
//         </div>
...
//       {/* Status messages */}
//       {order.status !== "approved" && (
//         <div className="border border-[#B58C47]/25 rounded-xl p-4 text-center">
//           {order.status === "pending" && (
...
//           )}
//           {order.status === "completed" && (
//             <p className="text-[#B58C47] font-semibold text-xl">
//               ✅ Enjoy your meal!
//             </p>
//           )}
//           {order.status === "rejected" && (
